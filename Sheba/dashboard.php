...
<div class="container-fluid">
    <p></p>
    <h1><span class="badge badge-pill badge-danger">AC Service Orders</span></a></h1>
    <p></p>
    <table class="table">
        ...
        <?php
            ...
            while ($info = mysqli_fetch_array ($result) ) {
                ...
                <tr>
                    ...
                    <td> '.$type.' </td>
                    <td>
                        <button class="btn btn-danger"><a href="delete_order.php? deleteac='.$id.'" class="text-light">Deliver</a></button>
                    </td>
                </tr>';
            }
            $count++;
...
<div class="container-fluid">
    <p></p>
    <h1><span class="badge badge-pill badge-danger">Ceiling Fan Service Orders</span></a></h1>
    <p></p>
    <table class="table">
        <thead class="thead-dark">
        <tr>
        ...
        while ($info = mysqli_fetch_array ($result) ) {
            ...
            echo '
                <tr>
                    ...
                    <td> '.$type.' </td>
                    <td>
                        <button class="btn btn-danger"><a href="delete_order.php? deleteceil='.$id.'" class="text-light">Deliver</a></button>
                    </td>
                </tr>';
        }
        $count++;
...
<!--for drilling service-->
<div class="container-fluid">
    <p></p>
    <h1><span class="badge badge-pill badge-danger">Drilling Service Orders</span></a></h1>
    <p></p>
    <table class="table">
        <thead class="thead-dark">
        <tr>
        ...
        while ($info = mysqli_fetch_array ($result) ) {
            ...
            echo '
                <tr>
                    ...
                    <td> '.$type.' </td>
                    <td>
                        <button class="btn btn-danger"><a href="delete_order.php? deletedrill='.$id.'" class="text-light">Deliver</a></button>
                    </td>
                </tr>';
        }
        $count++;
...
<div class="container-fluid">
    <p></p>
    <h1><span class="badge badge-pill badge-danger">Driving Service Orders</span></a></h1>
    <p></p>
    <table class="table">
        <thead class="thead-dark">
        <tr>
        ...
        while ($info = mysqli_fetch_array ($result) ) {
            ...
            echo '
                <tr>
                    ...
                    <td> '.$type.' </td>
                    <td>
                        <button class="btn btn-danger"><a href="delete_order.php? deletedrive='.$id.'" class="text-light">Deliver</a></button>
                    </td>
                </tr>';
        }
        $count++;
...
<div class="container-fluid">
    <p></p>
    <h1><span class="badge badge-pill badge-danger">Painting Service Orders</span></a></h1>
    <p></p>
    <table class="table">
        <thead class="thead-dark">
        <tr>
        ...
        while ($info = mysqli_fetch_array ($result) ) {
            ...
            echo '
                <tr>
                    ...
                    <td> '.$type.' </td>
                    <td>
                        <button class="btn btn-danger"><a href="delete_order.php? deletepaint='.$id.'" class="text-light">Deliver</a></button>
                    </td>
                </tr>';
        }
        $count++;
...
<div class="container-fluid">
    <p></p>
    <h1><span class="badge badge-pill badge-danger">Plumbing Service Orders</span></a></h1>
    <p></p>
    <table class="table">
        <thead class="thead-dark">
        <tr>
        ...
        while ($info = mysqli_fetch_array ($result) ) {
            ...
            echo '
                <tr>
                    ...
                    <td> '.$type.' </td>
                    <td>
                        <button class="btn btn-danger"><a href="delete_order.php? deleteplumbing='.$id.'" class="text-light">Deliver</a></button>
                    </td>
                </tr>';
        }
        $count++;
...
<div class="container-fluid">
    <p></p>
    <h1><span class="badge badge-pill badge-danger">Welding Service Orders</span></a></h1>
    <p></p>
    <table class="table">
        <thead class="thead-dark">
        <tr>
        ...
        while ($info = mysqli_fetch_array ($result) ) {
            ...
            echo '
                <tr>
                    ...
                    <td> '.$type.' </td>
                    <td>
                        <button class="btn btn-danger"><a href="delete_order.php? deleteweld='.$id.'" class="text-light">Deliver</a></button>
                    </td>
                </tr>';
        }
        $count++;
