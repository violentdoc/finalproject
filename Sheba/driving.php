...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    if(isset($_SESSION['user_id'])) {
        ...
        $query = "INSERT INTO `drive` (`name`, `phone`, `address`, `type`, `orderuser`) VALUES ('$name', '$phone', '$address', '$type', '$orderuser');";
...
<div class="container my-4" style="text-align: center">
    <h1 style="font-weight: bold">Driving Service</h1>
</div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6" style="padding-right: 50px">
            <img src="images/Package/driving.jpg" style="max-width: 100%; height: 92%; align-content: center">
        </div>
        <!--        order area-->
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="orderType" name="type">
                        <option>Driver Service(200tk/hourly)</option>
                        <option>Car Rental (2000-5000tk)</option>
                        <option>Home Shifting (4000-15000tk)</option>
                    </select>
                </div>
