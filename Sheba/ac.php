...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    if(isset($_SESSION['user_id'])) {
        ...
        $query = "INSERT INTO `ac` (`name`, `phone`, `address`, `type`, `orderuser`) VALUES ('$name', '$phone', '$address', '$type', '$orderuser');";
...
<div class="container my-4" style="text-align: center">
    <h1 style="font-weight: bold">AC Service</h1>
</div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6" style="padding-right: 50px">
            <img src="images/Package/ac.jpg" style="max-width: 100%; height: 92%; align-content: center">
        </div>
        <!--        order area-->
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="orderType" name="type">
                        <option>Basic 1-1.5 ton (450tk)</option>
                        <option>Basic 2-3 ton (650tk)</option>
                        <option>Basic 4-5 ton (950tk)</option>
                        <option>Jet 1-1.5 ton (900tk)</option>
                        <option>Jet 2-3 ton (1900tk)</option>
                        <option>Jet 4-5 ton (2900tk)</option>
                    </select>
                </div>
