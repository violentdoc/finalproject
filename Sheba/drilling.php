...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    if(isset($_SESSION['user_id'])) {
        ...
        $query = "INSERT INTO `drill` (`name`, `phone`, `address`, `type`, `orderuser`) VALUES ('$name', '$phone', '$address', '$type', '$orderuser');";
...
<div class="container my-4" style="text-align: center">
    <h1 style="font-weight: bold">Drilling Service</h1>
</div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6" style="padding-right: 50px">
            <img src="images/Package/drilling.jpg" style="max-width: 100%; height: 92%; align-content: center">
        </div>
        <!--        order area-->
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="type">
                        <option>Wall Drilling (100tk)</option>
                    </select>
                </div>
