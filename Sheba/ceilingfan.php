...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    if(isset($_SESSION['user_id'])) {
        ...
        $query = "INSERT INTO `ceil` (`name`, `phone`, `address`, `type`, `orderuser`) VALUES ('$name', '$phone', '$address', '$type', '$orderuser');";
...
<head>
    ...
    <title>Ceiling Fan Service</title>
</head>
<body>
...
<div class="container my-4" style="text-align: center">
    <h1 style="font-weight: bold">Ceiling Fan Service</h1>
</div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6" style="padding-right: 50px">
            <img src="images/Package/ceilingfan.jpg" style="max-width: 100%; height: 92%; align-content: center">
        </div>
        <!--        order area-->
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="orderType" name="type">
                        <option>Installation (150tk)</option>
                        <option>Basic Repair (350tk)</option>
                        <option>Coil Repair (800tk)</option>
                    </select>
                </div>
