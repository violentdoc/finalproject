...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    if(isset($_SESSION['user_id'])) {
        ...
        $query = "INSERT INTO `weld` (`name`, `phone`, `address`, `type`, `orderuser`) VALUES ('$name', '$phone', '$address', '$type', '$orderuser');";
...
<div class="container my-4" style="text-align: center">
    <h1 style="font-weight: bold">Welding Service</h1>
</div>
...
<!--        available package-->
        <div class="col-md-6" style="padding-right: 50px">
            <img src="images/Package/welding.jpg" style="max-width: 100%; height: 92%; align-content: center">
        </div>
<!--        order area-->
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="orderType" name="type">
                        <option>Basic Welding (200-350tk)</option>
                    </select>
                </div>
