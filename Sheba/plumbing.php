...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    if(isset($_SESSION['user_id'])) {
        ...
        $query = "INSERT INTO `plumbing` (`name`, `phone`, `address`, `type`, `orderuser`) VALUES ('$name', '$phone', '$address', '$type', '$orderuser');";
...
<div class="container my-4" style="text-align: center">
    <h1 style="font-weight: bold">Plumbing Service</h1>
</div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6" style="padding-right: 50px">
            <img src="images/Package/plumbing.jpg" style="max-width: 100%; height: 92%; align-content: center">
        </div>
        <!--        order area-->
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="type">
                        <option>Plumbing Checkup (100tk)</option>
                        <option>Normal Bibcock (120tk)</option>
                        <option>Sink Bibcock (200tk)</option>
                        <option>Shower Bibcock (700tk)</option>
                        <option>Water Meter Installation (600tk)</option>
                        <option>Sink Installation (700tk)</option>
                        <option>Sink Repair/Blockage (300tk)</option>
                    </select>
                </div>
